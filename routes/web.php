...
//采風堂
Route::get('/one',['as'=>'admin.one.index','uses'=> 'OneController@one']);
Route::get('/one',['as'=>'admin.one.index','uses'=> 'OneController@show']);

//匯川堂
Route::get('/two',['as'=>'admin.two.index','uses'=> 'TwoController@two']);
Route::get('/two',['as'=>'admin.two.index','uses'=> 'TwoController@show']);